...
void StyeColorsApp() {
    static constexpr auto bg_dark = ImVec4(0.15f, 0.16f, 0.21f, 1.00f);
    static constexpr auto bg_mid = ImVec4(0.20f, 0.21f, 0.27f, 1.00f);
    static constexpr auto accent_dark = ImVec4(0.292f, 0.360f, 0.594f, 1.000f);
    static constexpr auto accent_light = ImVec4(0.409f, 0.510f, 0.835f, 1.000f);
    static constexpr auto active = ImVec4(0.107f, 0.118f, 0.157f, 1.000f);
    static constexpr auto attention = ImVec4(0.821f, 1.000f, 0.000f, 1.000f);
    ...
    constexpr ImU32 Dracula[]  = {4288967266, 4285315327, 4286315088, 4283782655, 4294546365, 4287429361, 4291197439, 4294830475, 4294113528, 4284106564                        };
...
App::App(std::string title, int w, int h, int argc, char const *argv[]) {
    ...
    glfwSwapInterval(no_vsync ? 0 : 1); // Enable vsync
